...
die_area = pd.read_csv(
    "demo/figure6/real_hardware/die_area.csv", header=None, names=["A100", "MI210"]
)
...
plt.savefig("demo/figure6/figure6a.pdf", bbox_inches="tight", pad_inches=0.01, dpi=300)
...
plt.savefig("demo/figure6/figure6b.pdf", bbox_inches="tight", pad_inches=0.01, dpi=300)
